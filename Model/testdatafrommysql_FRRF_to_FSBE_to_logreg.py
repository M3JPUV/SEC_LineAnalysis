...
for X in range(len(year)):
    ...
    data_for_RF = data.drop(['Team', 'Conf', 'Pyth', 'Pyth_Rank', 'Adj_O', 'Rk_Adj_O', 'Adj_D', 'Rk_Adj_D', 'Opp_Adj_O', 'Rk_Opp_Adj_O', 'Opp_Adj_D', 'Rk_Opp_Adj_D', 'Opp_Pyth', 'Opp_Pyth_Rank', 'Rk_Off_Adj_Yards_/_Rush', 'Rk_Off_Adj_Yards_/_Pass', 'Rk_Off_Adj_Yards_/_Play', 'Rk_Def_Adj_Yards_/_Rush', 'Rk_Def_Adj_Yards_/_Pass', 'Rk_Def_Adj_Yards_/_Play'], axis=1, errors='ignore')

    #print('\n\n\nDATA_FOR_RF.COLUMNS: ',data_for_RF.columns);    
    from Feature_Reducing_Random_Forest import FRRR;
    top_40_list_of_features_from_RF = FRRR(40,data_for_RF,data_for_RF["Act_W_%"]);
    ...
    for i in range(len(data['Conf'].unique())):
        ...
        if "Act_W_%" in top_40_list_of_features_from_RF:
            #1)does not need "Act_W_%" in x , remove updates the list for you....
            top_40_list_of_features_from_RF.remove("Act_W_%");
        ...
        top_12_list_of_features_from_BE = FSBL(data_for_BE[top_40_list_of_features_from_RF],data_for_BE["Act_W_%"],8,temp);
        if DEBUG:
            print('top_40_list_of_features_from_RF\n',top_40_list_of_features_from_RF);
        ...
        if "Act_W_%" in top_40_list_of_features_from_RF:
            #1)does not need "Act_W_%" in x , remove updates the list for you....
            top_12_list_of_features_from_BE.remove("Act_W_%");
...
# builds a table to read from later
        ...
        top_12_list_of_features_from_BE.append("Act_W_%");
